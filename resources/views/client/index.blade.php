...
@section('content')
 ...
 <section id="banner">
    ...
    <div id="main-slider" class="flexslider">
        <ul class="slides">
            <li>
                <img src="{{asset('plugins/home-plugins/img/slides/1.jpg')}}" alt="" />
            ...
            <li>
                <img src="{{asset('plugins/home-plugins/img/slides/2.jpg')}}" alt="" />
                <div class="flex-caption">
                    <h3>Specialize</h3> 
                ...
                <div class="testimonials">
                    <div class="active item">
                        ...
                        <div class="carousel-info">
                            <img alt="" src="{{asset('plugins/home-plugins/img/team4.jpg')}}" class="pull-left">
                            <div class="pull-left">
